...
public class ReferenceSource implements CRAMReferenceSource {
    ...
    // Optimize for locality of reference and maintain the backing reference bases for the most recent request.
    // Failure to do this will result in the bases being aggresively GC'd due to the weak reference map, resuling
    // in much thrashing.
